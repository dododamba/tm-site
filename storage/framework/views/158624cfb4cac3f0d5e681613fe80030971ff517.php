    ...
    <section id="mu-slider">
        ...
        <div class="mu-slider-single">
            <div class="mu-slider-img">
                <figure>
                    <img src="/<?php echo e($item->image->nom); ?>" alt="<?php echo e($item->image->alt); ?>" style="height: 500px;width: 1920px;">
                </figure>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="mu-service-area">
                        ...
                        <div class="mu-service-single" style="background-color : purple;">
                            <span class="fa fa-users"></span>
                            <h3>Dynamisme</h3>
...
<?php /* /home/devtools/PHP/tmpsite/resources/views/home.blade.php */ ?>