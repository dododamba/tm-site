    ...
    <div class="row">
        <?php $__currentLoopData = $logo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="column">
                ...
                <button type="button" class="btn btn-success" href="#DemoModal<?php echo e($item->id); ?>"
                        data-toggle="modal" >Voir</button>
            </div>
            <div id="DemoModal<?php echo e($item->id); ?>" class="modal fade "> <!-- class modal and fade -->
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body"> <!-- modal body -->
                            ...
                            <img src="<?php echo e($item->nom); ?>" alt="<?php echo e($item->alt); ?>" style="width:600px;height: 600px">
                        ...
                        <div class="modal-footer">
                            ...
                            <?php echo Form::submit('Effacer', ['class' => 'btn btn-danger']); ?>
...
<?php /* /home/devtools/PHP/projects/tmp/resources/views/backEnd/admin/logo/index.blade.php */ ?>