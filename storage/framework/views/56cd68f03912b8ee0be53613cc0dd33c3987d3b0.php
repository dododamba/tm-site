            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mu-contact-left">
                  <form class="contactform" action="<?php echo e(route('message.contact.create')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /* /home/devtools/PHP/projects/tm-site/resources/views/contact.blade.php */ ?>