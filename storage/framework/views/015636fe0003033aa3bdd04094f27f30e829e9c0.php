<?php $__env->startSection('title','Message Contact'); ?>
           ...
           <div class="w-full sm:w-1/2 md:w-1/3 flex flex-col p-3">
             <div class="bg-white rounded-lg shadow-lg overflow-hidden flex-1 flex flex-col">
               <div class="bg-cover h-48"
                    style="background-image: url(https://images.unsplash.com/photo-1523978591478-c753949ff840?w=900);"></div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mu-contact-left">
                  <form class="contactform" action="<?php echo e(route('messagecontact.create')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /* /home/devtools/PHP/tmpsite/resources/views/contact.blade.php */ ?>