        ...
        <div class="toast toast--green add-margin">
            <div class="toast__icon">
                <svg version="1.1" class="toast__svg" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                     viewBox="0 0 301.691 301.691" style="enable-background:new 0 0 301.691 301.691;"
                     xml:space="preserve">
<g>
    ...
    <rect x="130.563" y="261.168" width="40.525" height="40.523"></rect>
            ...
            <div class="toast__content">
                ...
                <p class="toast__message"><?php echo e(session()->get('success')); ?></p>
            </div>
...
<?php /* /home/devtools/PHP/projects/tmp/resources/views/alert/alert_success.blade.php */ ?>