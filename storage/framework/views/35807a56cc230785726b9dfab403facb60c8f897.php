    ...
    <div class="container">
            ...
            <?php $__currentLoopData = $medias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                    ...
                    <button type="button" class="btn btn-secondary mb-1" data-toggle="modal" data-target="#mediumModal<?php echo e($item->id); ?>">
                            Voir
                    </button>
...
<?php /* /home/devtools/PHP/projects/tmp/resources/views/backEnd/admin/gallery/index.blade.php */ ?>