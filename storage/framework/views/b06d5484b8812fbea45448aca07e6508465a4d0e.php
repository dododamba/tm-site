...
<?php $__env->startSection('content'); ?>
    ...
    <h1>Role <a href="<?php echo e(url('role/create')); ?>" class="btn btn-primary pull-right btn-sm"><i class="fa fa-plus"></i></a></h1>
        ...
        <table class="table table-bordered table-striped table-hover" id="tblrole">
            ...
            <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><a href="<?php echo e(url('role', $item->id)); ?>"><?php echo e($item->name); ?></a></td><td><?php echo e($item->description); ?></td>
                    <td>
                        <a href="<?php echo e(url('role/' . $item->id . '/edit')); ?>" class="btn btn-primary btn-xs">Update</a>
                        <?php echo Form::open([
                            'method'=>'DELETE',
                            'url' => ['role', $item->id],
...
<?php /* /home/devtools/PHP/projects/tm-site/resources/views/backEnd/admin/role/index.blade.php */ ?>