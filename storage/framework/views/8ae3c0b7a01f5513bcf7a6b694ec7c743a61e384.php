    ...
    <div class="content mt-3">
        <div class="animated fadeIn">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form action="<?php echo e(route('profile.picture.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php /* /home/devtools/PHP/projects/tm-site/resources/views/backEnd/admin/user/profile_pict.blade.php */ ?>