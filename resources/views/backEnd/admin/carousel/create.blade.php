...
@section('content')
    ...
    <div class="form-group">
        ...
        <div class="row">
            {!! Form::label('lien', 'Charger une image : ', ['class' => 'col-sm-3 control-label']) !!}
            @if(session()->has('image'))
                <div class="col-sm-3">
                    <div class="column">
                        <img src="/{{session()->get('image')}}" alt="" style="width:250px;height: 250px">
                    ...
                    <div class="col-md-12">
                        @foreach($medias as $item)
                            <div class="column">
                                ...
                                <a type="button" class="btn btn-success" href="{{ url('selectionner' , $item->id ) }}"
